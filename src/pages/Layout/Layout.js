    ...
    <div className="layout">
      ...
      <section className="portfolio">
        ...
        <p className="portfolio-subtext">
          ...
          <a
            ...
            href="http://www.mybackupcash.com"
          >
            Mybackupcash
          </a>{' '}
          ,
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="http://www.business.sendbox.co"
          >
            Sendbox Business
          </a>{' '}
          ,
          <a
            href="http://www.sendbox.shop"
            target="_blank"
            rel="noopener noreferrer"
          >
            Sendbox Shop
      ...
      <section className="portfolio">
        ...
        <p className="portfolio-subtext">
          ...
          tech talents at{' '}
          <a href="http://www.techfront.io">Techfront io</a>
        </p>
      ...
      <section className="portfolio">
        ...
        <p className="portfolio-subtext">
          ...
          {/*<a href="http://www.Dev.to">Dev.to</a>,{' '}*/}
          {/*<a href="http://www.medium.com">Medium</a>,{' '}*/}
          {/*<a href="http://www.hashnode.com">hashnode</a>,*/}
        ...
        <div className="portfolio-list">
          ...
          {/*</li>*/}
          {/*<li>*/}
          {/*  <a href="http://www.techfront.io">Medium.co</a>*/}
          {/*</li>*/}
          {/*<li>*/}
          <a
      ...
      <section className="portfolio">
        ...
        <p className="portfolio-subtext">
          ...
          <a href="http://www.Dev.to">Writing Docs</a>,{' '}
          <a href="http://www.medium.com">Agenta AI</a>,{' '}
          <a href="http://www.hashnode.com">Docusaurus</a>,{' '}
          <a href="http://www.hashnode.com">Codecademy Docs</a>,
        </p>
        {/*<ul className="portfolio-list">*/}
        {/*  <li>*/}
        {/*    <a href="https://dev.to/lucciddev/getting-started-with-react-context-mc7">*/}
        ...
        {/*  </li>*/}
        {/*  <li>*/}
        {/*    <a href="http://www.techfront.io">hashnode.com</a>*/}
        {/*  </li>*/}
        {/*</ul>*/}
      </section>{' '}
